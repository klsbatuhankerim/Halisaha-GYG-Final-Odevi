...
<div class="container">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $name = htmlspecialchars($_POST['name']);//XSS AÇIĞININ KAPATILMASI
        $comment = htmlspecialchars($_POST['comment']);//XSS AÇIĞININ KAPATILMASI
    ...
    <div id="comments">
        ...
        <ul id="commentList">
            ...
            while ($row = $results->fetchArray(SQLITE3_ASSOC)) {
                echo "<li><strong>" .htmlspecialchars($row['name']) . ":</strong> " . htmlspecialchars($row['comment']) . "</li>";//XSS AÇIĞININ KAPATILMASI
            }
            ?>
        </ul>
    </div>
